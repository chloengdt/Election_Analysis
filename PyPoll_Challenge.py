...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_turnout > winning_county_voters) and (county_percentage > winning_county_percentage):
            winning_county_voters = county_turnout
    ...
    winning_county_summary = (
        ...
        f"Winning County Turnout: {winning_county_voters:,}\n"
